import { Alert, Button, Card, Checkbox, Col, Divider, Flex, Input, Modal, Popover, Radio, Row, Select, Space, Typography } from 'antd'
                ...
                <Col md={{ span: 16 }}>
                    <Card className='mt-2' style={{ border: "1px solid #DDE2E8", padding: '0.5rem' }}>
                        ...
                        <Flex className='mt-2'>
                                ...
                                <Flex flex={1} vertical align='center'>
                                    ...
                                    <Row gutter={[20, 5]}>
                                        {seats.map((seat) =>
                                            ...
                                            <Col key={seat.seatName} span={seat.seatName.includes('01') ? 16 : 8}><Seat onClick={() => handleSeatClick(seat)} {...seat} /></Col>
                                        )}
                                    </Row >
                                </Flex>
                                {/* floor 2 */}
                            ...
                            <Flex flex={1} vertical gap={20} className='mt-2 ml-2'>
                        ...
                        <Flex justify='space-between'>
                            ...
                            <Flex gap={10}>
                                ...
                                <Button type="primary" style={{ backgroundColor: '#ef5222' }} shape="round" size='middle'>
                                    Thanh Toán
                                </Button>
                            </Flex>
                        </Flex>
